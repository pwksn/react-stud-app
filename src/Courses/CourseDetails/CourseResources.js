        ...
        <div>
            <h2>Resources</h2>
                <div className="course-details-resources-tiles">
                    {currentCourse.upelLink && <div className="course-details-resources-tile course-details-resources-tile-upel" onClick={() => openInNewTab(currentCourse.upelLink)}>
                    ...
                    {currentCourse.eLectureLink && <div className="course-details-resources-tile course-details-resources-tile-eLecture" onClick={() => openInNewTab(currentCourse.eLectureLink)}>
                    ...
                    {currentCourse.driveLink &&<div className="course-details-resources-tile course-details-resources-tile-drive" onClick={() => openInNewTab(currentCourse.driveLink)}>
